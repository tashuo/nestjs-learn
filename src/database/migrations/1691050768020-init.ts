...
export class Init1691050768020 implements MigrationInterface {
    name = 'Init1691050768020';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE \`user_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`github_id\` int NOT NULL DEFAULT '0', \`github_user\` json NULL, \`username\` varchar(255) NOT NULL, \`nickname\` varchar(255) NOT NULL, \`avatar_path\` varchar(255) NOT NULL DEFAULT '', \`gender\` varchar(255) NOT NULL DEFAULT '未知', \`description\` varchar(255) NOT NULL DEFAULT '', \`password\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, INDEX \`IDX_75e3a27b2e8d8c5f4033db2004\` (\`github_id\`), UNIQUE INDEX \`IDX_9b998bada7cff93fcb953b0c37\` (\`username\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
